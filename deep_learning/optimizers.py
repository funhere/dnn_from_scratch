...
# Optimizers for models that use gradient based methods;
# Finding the weights that minimizes the loss.
# Refer to resource for understanding these methods: 
...
class Adam():
    def __init__(self, learning_rate=0.0002, b1=0.9, b2=0.99):
        self.learning_rate = learning_rate
        self.eps = 1e-8
        self.m = None
        self.v = None
